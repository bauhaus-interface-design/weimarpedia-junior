...
if (typeof(google.maps.Polygon.prototype.runEdit) === "undefined") {
  ...
  google.maps.Polygon.prototype.runEdit = function (flag) {
	if (this.mode == "edit") this.stopEdit();
    ...
    if (flag) {
      var imgGhostVertex = new google.maps.MarkerImage(
                'typo3conf/ext/wpj/Resources/Public/map/ghostVertex.png', new google.maps.Size(6, 6),
                new google.maps.Point(0, 0), new google.maps.Point(3, 3));
      var imgGhostVertexOver = new google.maps.MarkerImage(
                'typo3conf/ext/wpj/Resources/Public/map/ghostVertexOver.png', new google.maps.Size(6, 6),
                new google.maps.Point(0, 0), new google.maps.Point(3, 3));
    ...
    var imgVertex = new google.maps.MarkerImage('typo3conf/ext/wpj/Resources/Public/map/vertex.png',
      new google.maps.Size(11, 11), new google.maps.Point(0, 0),
      new google.maps.Point(6, 6));
    var imgVertexOver = new google.maps.MarkerImage('typo3conf/ext/wpj/Resources/Public/map/vertexOver.png',
      new google.maps.Size(11, 11), new google.maps.Point(0, 0),
      new google.maps.Point(6, 6));
