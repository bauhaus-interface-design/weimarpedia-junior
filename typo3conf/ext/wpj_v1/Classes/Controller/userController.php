...
class Tx_WpjV1_Controller_userController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_WpjV1_Domain_Repository_userRepository
	 */
	...
	protected function initializeAction() {
		$this->userRepository = t3lib_div::makeInstance('Tx_WpjV1_Domain_Repository_userRepository');
	}
