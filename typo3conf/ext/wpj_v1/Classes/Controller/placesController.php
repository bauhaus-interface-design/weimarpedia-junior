...
class Tx_WpjV1_Controller_placesController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_WpjV1_Domain_Repository_placesRepository
	 */
	...
	protected function initializeAction() {
		$this->placesRepository = t3lib_div::makeInstance('Tx_WpjV1_Domain_Repository_placesRepository');
	}
